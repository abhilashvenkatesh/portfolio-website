...
## hire-me CTA
A mailto anchor rendered in the persistent nav header as an **action**, distinct from nav links (which are page navigation). Sits as a sibling to `<nav>`, not inside it. Opens the visitor's email client pre-addressed to the site owner.
